...
- Experimental41 root native49536 completed12frames with0holds; offline annotation11367 completed all12 and all11 new candidate frames passed the single-answer numerical checks. The final paired control is excluded from export. Returning to the same B camera with1 warmup preserved exact depth/9mm geometry and the same annotation; RGB mean byte difference3.73 still requires actual visual review. All11 candidate frames have59.96-64.65% actual background plants and zero unknown pixels. Actual visual review/export are pending; published count stays476. Production requests remain approximately11-13s each.
...
`native848_scene_sweep_capture_v1.py` (SHAe93134bc010bc65d4734787fd7e9eef7f6dac9a535b166d691d43db0b0b96e15) passed27 CPU guard checks; offline consumer passed20, preserving the existing full-scene9mm/junction/ambiguity numerical routines. The source request is `data/sim_data/diagnostics/native848_fixed_scene_sweep_combined55_prepare_20260918_v1/request.json` (SHA8644392a19b2ea47ca2761eb0120856ca78136d31b5b458bb0b3420bfd867852).

Root native session46624 is active at `C:/Users/USER/tomato-vlm-data-20260917/diagnostics/fixed144_sweep55_native_20260918_v1`:55 distinct plant-relative candidate views across10 original donor shapes,11 physical vines and22 source/instance targets. This uses one scene, one product/writer and one initial warmup; RGB/depth/IDs are saved before offline annotation. Source images need not have passed previous visibility tests. Full native robot/FK/collision and source geometry checks remain.

CPU parent15174 tested272 proposals, with92 robot/workspace passes;40 were clone-angle repeats and others matched released local views. Novelty filtering retained39 distinct new local angles. Complement CPU3489 added16 distinct angles from4 additional donor families, including seed83. Both actual CPU owners closed0; combined55 exact union passed final request checks without claiming a geometry rerun. Views on copied vines are not counted as new independent shapes. Native capture/annotation/visual acceptance are pending; do not count55 as released images.

Native render speed remains a separate bottleneck. Audit existing shorter-subframe benchmarks before proposing the next bounded comparison; do not change the live8-subframe profile or claim an unmeasured speedup. Prepare genuinely new camera angles/target identities in the same fixed greenhouse for subsequent sweeps.
