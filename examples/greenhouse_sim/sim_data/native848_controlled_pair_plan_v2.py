...
SCHEMA = 'greenhouse.native848_source_frame_controlled_pair_plan.v2'
SAMPLE_SCHEMA = 'greenhouse.native848_source_frame_controlled_pair_sample.v2'
...
def implementation_bindings():
    ...
    pending = [root/name for name in ('native848_controlled_pair_plan_v2.py',
        'native848_controlled_pair_worker_v2.py', 'native848_controlled_pair_audit_v2.py',
        'native848_controlled_scene_v2.py')]
    found = {}
    while pending:
