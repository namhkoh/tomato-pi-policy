"""V2 authored-metadata checker repair; identical two source-frame controls.
...
def code_bindings():
    names = ('procedural_petiole_controlled_v2.py','procedural_petiole_controlled_catalogue_v2.py',
...
def generate(plan_path, family, target, control, output):
    ...
    try:
        ...
        raw = deepcopy(source['raw']); raw.update(generator=VERSION, version='2.0.0', physics_supported=False,
