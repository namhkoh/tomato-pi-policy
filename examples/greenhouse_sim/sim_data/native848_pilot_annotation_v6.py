...
from . import native848_pilot_parallel_predecessor_v3 as parallel_predecessor
...
SCHEMA='greenhouse.native848_filtered_pilot_9mm_evaluation.v6'
OWNER_SCHEMAS={
...
def check_recovery(spec):
    ...
    implementations={recovery.SCHEMA:recovery,latest_recovery.SCHEMA:latest_recovery,failed68_recovery.SCHEMA:failed68_recovery}
