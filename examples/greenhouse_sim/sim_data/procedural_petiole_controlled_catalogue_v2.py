...
from .procedural_petiole_controlled_v2 import VERSION, plan_change_explicit, verify_components, code_bindings
...
def load_for_inspection(directory, source_plan_path):
    ...
    return dict(schema_version='greenhouse.explicit_control_rigid_leaf_inspection_catalogue.v2', directory=str(directory),
