...
from . import native848_owned_retirement_v1 as retirement
...
def main(argv=None):
    ...
    require(ticket['schema']=='greenhouse.native848_pilot_parallel_ticket.v2' and type(ticket['worker_count']) is int and ticket['worker_count'] in (2,3,4)
    ...
    try:
        ...
        admission=retirement.inventory(control.parent,coordinator,release['slots'],protected_slot=ticket['slot'])
