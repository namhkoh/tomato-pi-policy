...
SCHEMA='greenhouse.native848_fully_labeled_coverage.v3'
...
def evaluate_frame(metadata,rgb,depth,valid,components,catalogue,target_inventory,workspace_checker,*,scene_coverage=None):
    ...
    for row in rows:
        row['annotation_epoch']=labels.ANNOTATION_EPOCH  # same zero-pixel/unknown predicates, explicit current epoch
