"""Batch v2 full-greenhouse scene, restored from fresh native reference pose.
...
def prepare_scene(app, plan):
    from .execution_v1 import require_running_app
    require_running_app(app)
    # Full bank/geometry replay follows the initialized native application.
    import sys
    import carb
    import omni.usd
