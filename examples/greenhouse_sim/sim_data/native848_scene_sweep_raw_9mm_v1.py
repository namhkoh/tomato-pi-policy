...
def evaluate_capture(capturepath,output):
    ...
    try:
        for receipt,obs in zip(result['frames'],observations):
            ...
            cov=dict(schema='greenhouse.native848_all_petiole_coverage_audit.v1',observation=obspin,observation_path=obspin['path'],observation_sha256=obspin['sha256'],context=result['context'],
                context_path=result['context']['path'],context_sha256=result['context']['sha256'],
