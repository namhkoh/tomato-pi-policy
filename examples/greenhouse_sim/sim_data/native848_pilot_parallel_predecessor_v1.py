...
SCHEMAS={'greenhouse.native848_pilot_parallel.v1'}
...
def check_parallel(value,*,rows=None):
    ...
    if result['schema'] in ('greenhouse.native848_pilot_parallel.v1',):
    ...
    owner_path=ROOT/'data/sim_data/diagnostics/collection_20k_848_20260916_v1/run_native848_pilot_parallel_v1.py'
    worker_path=Path(__file__).with_name('native848_pilot_sibling_worker_v1.py')
    ...
    for slot in slots:
        ...
        require(ticket['schema']=='greenhouse.native848_pilot_parallel_ticket.v1'
