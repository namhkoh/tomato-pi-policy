...
from . import native848_fully_labeled_coverage_v3 as full_coverage
...
SCHEMA='greenhouse.native848_fully_labeled_9mm_evaluation.v16'
OWNERS={
 ...
 'greenhouse.native848_fully_labeled_owner.v7':('run_native848_fully_labeled_serial_v7.py','6ca5baf9a6a5a0dfb69b316e9871fc1f8ecb0309b19fef63441a7c90d09e6851',worker3,'8882e3d0c73d26ce2ffc2fa49d801fb8c2e684718b4f2581a31180a4f5099abe',plan3,'greenhouse.native848_fully_labeled_cpu_preflight.v3')}
...
COVERAGE_SHA256='8ca7167e0973f297bc23c129484e0e379794f713dcc1bdb104ceceb6adfc9536'
...
def run(trial,result_sha256,output,*,parent_metadata=None,parent_recovery=None,start_index=0,frame_count=16):
    ...
    require(sha256(labels.__file__)=='c5704371017b9f5943664e8a4d156d5e7f2e6d71f8b48ef8e5f4efee01ae13c1' and sha256(labels.joint_ownership.__file__)=='37f7b121202a3e04c45166ab47c8e976bc7d4c74cfa546d1ac1ae65bf4d2f6aa','Frozen verified-joint implementations changed')
    pins[str(Path(labels.joint_ownership.__file__).resolve())]='37f7b121202a3e04c45166ab47c8e976bc7d4c74cfa546d1ac1ae65bf4d2f6aa'
    ...
    for committed_index in indices:
        ...
        for target in annotation['targets']:
            ...
            if joint is not None:
                require(all(pins.get(path)==h for path,h in joint['source_bindings'].items()),'Joint proof must use the exact already-authenticated native source geometry')
