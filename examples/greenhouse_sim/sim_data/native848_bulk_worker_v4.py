"""Admission-only wrapper for two or three owned sustained compact bulk workers.
...
from . import native848_bulk_sibling_gate_v4 as gate
...
def main(argv=None):
    ...
    require(ticket['schema']=='greenhouse.original848_sustained_worker_ticket.v1' and type(ticket['worker_count']) is int and ticket['worker_count'] in (2,3)
