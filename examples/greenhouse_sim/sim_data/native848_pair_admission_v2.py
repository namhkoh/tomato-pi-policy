...
from . import native848_pair_plan_v2 as plan_api,native848_pair_audit_v2 as audit_api
...
def implementation_bindings():
    ...
    names=['native848_pair_admission_v2.py','native848_clear_labels_v1.py','native848_query_selection_v1.py',
...
def run(trial,*,result_sha256,output):
    ...
    require(launch['command'][-1]==str(trial/'capture') and 'sim_data.native848_pair_worker_v2' in launch['command'],'Wrong native worker route')
