...
SCHEMA='greenhouse.original848_bulk_live_prefix_closure.v4'
...
def prepare_review_prefix(context_path,context_sha256,admissions,prior,prior_sha256,output,
    ...
    if capture_start:
        ...
        require(previous_receipt['schema'] in (SCHEMA,'greenhouse.original848_bulk_live_prefix_closure.v2',
            'greenhouse.original848_bulk_live_prefix_closure.v3') and previous_receipt['context_sha256']==context_sha256
    ...
    result=dict(schema='greenhouse.original848_bulk_live_prefix_review.v4',
