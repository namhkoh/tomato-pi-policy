...
SCHEMA = 'greenhouse.native848_diverse_group_inventory.v3'
REVIEW_SCHEMA = 'greenhouse.native848_diverse_group_review.v3'
...
def inventory(result_path,result_sha256,hold_snapshot,policy_spec,pins):
    ...
    for row in rows:
        require((row.get('q4_group_review_authorized') is True)==(result['schema']=='greenhouse.native848_diverse_bulk_q4_background_post.v3'),
...
def prepare_group_review(normalized_result_path,result_sha256,hold_ledger_path,output):
    ...
    write(out/'visual_packet.json',dict(schema='greenhouse.native848_diverse_group_visual_packet.v3',
