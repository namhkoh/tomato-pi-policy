"""Reviewed experimental persistent candidates; paired controls can never be exported.
...
from . import native848_persistent_experimental_9mm_v1 as persistent
from . import native848_persistent_experimental_capture_v1 as producer
...
PINS={**PINS,
    ...
    persistent.__file__:'4f390e9bee8a6d4a98b2118ba7f3d41d7c5a443ded201921efcb6047075e48af',
    producer.__file__:'0a07c17b2a5ff3114ed4f006bdec7f2141882d780b697617b189a71792e75a7b',
...
AUTHORITY_KIND='one_native_batch_owner_with_explicit_experimental_warmups'
...
def validate_persistent_authority(value,authority,capture,delegation):
    ...
    require(value['experimental_profile'] is True and value['production_profile_qualification'] is False
        and public['experimental_profile'] is True
        and value['capture_purpose']==public['capture_purpose']==captured['capture_purpose']==scheduled['purpose']==producer.diagnostic.CANDIDATE
        and value['export_prohibited'] is public['export_prohibited'] is captured['export_prohibited'] is False
        and value['paired_control_reference'] is public['paired_control_reference'] is captured['paired_control_reference'] is scheduled['paired_control_reference'] is None,
        'Only individually reviewed experimental candidates are exportable; paired controls are permanently excluded')
    actual=public['actual_experimental_profile']
    require(actual==captured['actual_experimental_profile'] and actual['schema']==producer.diagnostic.ACTUAL_SCHEMA
        and actual['shortened_warmup_qualified'] is False and actual['experimental_profile'] is True
        and actual['warmup_steps']==[8]*scheduled['warmup_request_count'] and actual['request_subframes']==8
        and actual['training_approved'] is False and actual['accepted_training_increment']==0,
        'Actual experimental optical evidence differs or falsely claims profile qualification')
...
def materialize(evaluation_pin,selected_sample_ids,review_pin,output,*,authorization_pin):
    ...
    try:
        for x in checked:
            ...
            row=dict(schema=FRAME_SCHEMA,task_id=base.TASK,annotation_epoch=base.EPOCH,frame_id=name,split='train',source_family=donor,
                ...
                source_provenance=dict(evaluation=evaluation_pin,**x['record'],rgb=x['rgb_pin'],observation=x['observation'],review=review_pin,
                    ...
                    actual_experimental_profile=authority['public']['actual_experimental_profile'],
                    capture_purpose=authority['scheduled']['purpose'],paired_control_exported=False))
        ...
        manifest=dict(schema=SCHEMA,state='complete_reviewed_generated_supplement_pending_union',task_id=base.TASK,annotation_epoch=base.EPOCH,
            ...
            unchanged_generated_sensor_and_answer_schema=True,experimental_profile=True,production_profile_qualification=False,
            actual_experimental_profile=authority['public']['actual_experimental_profile'],paired_control_exported=False,
