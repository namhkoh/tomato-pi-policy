"""Finite read cache around the unchanged annotation16 predicates, at most16 frames."""
from pathlib import Path
from contextlib import ExitStack
from unittest.mock import patch
import os,json,time
from . import native848_pilot_annotation_v16 as annotation
...
SCHEMA='greenhouse.native848_cached_annotation_operation.v9'
...
def run(trial,result_sha256,output,*,parent_metadata=None,parent_recovery=None,start_index=0,frame_count=16):
    ...
    session.authenticate(annotation.ambiguity.dataset.__file__,annotation.ambiguity.DATASET_SHA256)
    ...
    with validation.Adapted(session),ExitStack() as stack:
        stack.enter_context(patch.object(annotation.ambiguity.dataset,'digest',session.digest))
