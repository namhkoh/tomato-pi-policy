"""Finite read cache around the unchanged annotation10 implementation, at most64 frames."""
from pathlib import Path
from contextlib import ExitStack
from unittest.mock import patch
import os,json,time
from . import native848_pilot_annotation_v10 as annotation
from . import native848_unique9mm_batch_validation_v1 as validation

ANNOTATION_SHA='93437effebdd2562e59752b378a652cf5df988a77f489183eefc6753086df982'
...
SCHEMA='greenhouse.native848_cached_annotation_operation.v3'
...
def run(trial,result_sha256,output,*,parent_metadata=None,parent_recovery=None,start_index=0,frame_count=64):
    validation.require(type(start_index) is int and start_index>=0 and type(frame_count) is int and 1<=frame_count<=64,'Finite annotation chunk of at most64 required')
