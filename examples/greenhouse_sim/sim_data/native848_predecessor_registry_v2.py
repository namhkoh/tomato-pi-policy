...
SCHEMA='greenhouse.native848_predecessor_registry.v2'
KEYS=frozenset(('metadata','result','terminal','outer_launch','outer_exit'))
REGISTRY={
    'greenhouse.native848_fully_labeled_owner.v6':(
        'run_native848_fully_labeled_serial_v6',H/'run_native848_fully_labeled_serial_v6.py',
        '5c604d001dd4e2657f2c6e813a2b8ef8252f1cc8ce185be6cb868173cb91f615','serial'),
    'greenhouse.native848_farmerge_pair_owner.v1':(
        'run_native848_farmerge_pair_serial_v1',H/'run_native848_farmerge_pair_serial_v1.py',
        '9ac80834a958f12a8ae1a0e948e78ce07cf966cfe701c6c53450fd8a00e83c8c','serial'),
...
FIXED_BINDINGS={
    str(M/'native848_predecessor_registry_v1.py'):'299abcfaccb25714082d93a1b331a4b8a34d1289e2920c513101861921e0fea3',
    str(M/'native848_farmerge_pair_plan_v1.py'):'ed6889131dece09a56298d4c4971b3a9b88913cae2099f099b42fd8b7b795262',
    str(M/'native848_farmerge_pair_scene_v1.py'):'4ec5e685fe68bf09376b7bdc6a047d1eaf8f026437dfa8de2b0003e021322a22',
    str(M/'native848_farmerge_pair_worker_v1.py'):'dcab83431f8b245677721ac1d93df0bd89b2ae73bf5341ab3742a0ab3f03f0a4',
