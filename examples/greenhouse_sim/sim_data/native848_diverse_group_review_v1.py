...
SCHEMA = 'greenhouse.native848_diverse_group_inventory.v1'
REVIEW_SCHEMA = 'greenhouse.native848_diverse_group_review.v1'
...
def inventory(result_path,result_sha256,hold_snapshot,policy_spec,pins):
    ...
    require(result['schema'] in ('greenhouse.native848_diverse_bulk_q3_adapter.v1',
        ...
        'greenhouse.native848_diverse_bulk_q3_adapter.v2'),'Unsupported normalization')
...
def prepare_group_review(normalized_result_path,result_sha256,hold_ledger_path,output):
    ...
    write(out/'visual_packet.json',dict(schema='greenhouse.native848_diverse_group_visual_packet.v1',
