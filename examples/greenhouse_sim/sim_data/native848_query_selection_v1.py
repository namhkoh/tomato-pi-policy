"""Explicit native848 CPU-only query selection; no frozen worker or label edits.
...
from . import native848_clear_labels_v1 as legacy_labels
...
from .native848_clear_labels_v1 import RESOLUTION, contract_hash
from .native_query_visibility import NativeQueryVisibility, POLICY as QUERY_POLICY

SCHEMA = 'greenhouse.native848_query_selection.v1'
ANNOTATION_EPOCH = SCHEMA
GRID_SCHEMA = 'greenhouse.native848_anchored_query_photometry.v1'
CANDIDATES = 41
START_MM = 8
STEP_MM = 5
MIN_QUERY_M = .045
...
def annotate_v1(metadata, report, rgb, depth, valid, components, catalogue, *,
                target_mask, expected_label=None):
    ...
    if label['eligible']:
        ...
        trace = dict(schema='greenhouse.native848_query_trace.v1', annotation_epoch=ANNOTATION_EPOCH,
