...
def build_inventory(context,reports,catalogue):
    ...
    from .native848_controlled_9mm_evidence_v2 import authenticate_9mm_evidence
...
def evaluate_capture(capturepath,output):
    """Evaluate one genuinely closed controlled capture, at most2 actual frames.
    ...
    from . import native848_controlled_capture_v1 as producer
    ...
    require(result['schema']==producer.RESULT_SCHEMA and result['state']=='captured_pending_complete_annotation_and_visual_review'
        ...
        and 0<=len(result['frames'])<=2 and complete['frames']==len(result['frames']),
