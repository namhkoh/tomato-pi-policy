...
SCHEMA='greenhouse.native848_diverse_bulk_q3_adapter.v4'
...
OWNER_SHA='526f6cd95bc405b72c4e2f14af48df989d57e029f7e2efd87518ccd562df2566'
WORKER_SHA='160089f6fb87628ca7d56962cb2552eee3fc4be22eaa75c9569190aa88311485'
GATE_SHA='3766afb02212dfa0bb432bb61c6dc9b3e45d7fbd259d778be6e7bc2b9a7150d4'
PREDECESSOR_SHA='d906cbedbd909be5d1981992d1db326680998e17c8fb1493a0c57504ae13bc9e'
...
def validate_parallel_shape(intent, parent_result, slot):
    ...
    require(parent_result['schema']==intent['schema']=='greenhouse.native848_multianchor_parallel.v1'
...
def load_owned(trial,cpu,native_result_sha256,cpu_result_sha256):
    ...
    require(trial.is_relative_to(ROOT/'data/sim_data/diagnostics') and trial.name.startswith('slot_'),
    ...
    for path,h in [(H/'run_native848_multianchor_parallel_v1.py',OWNER_SHA),
        (Path(__file__).with_name('native848_multianchor_sibling_worker_v1.py'),WORKER_SHA),
        (Path(__file__).with_name('native848_bulk_sibling_gate_v5.py'),GATE_SHA),
        (Path(__file__).with_name('native848_multianchor_parallel_predecessor_v1.py'),PREDECESSOR_SHA)]:
    ...
    require(ticket['schema']=='greenhouse.native848_multianchor_parallel_ticket.v1'
        ...
        and argument(command,'-m')=='sim_data.native848_multianchor_sibling_worker_v1'
