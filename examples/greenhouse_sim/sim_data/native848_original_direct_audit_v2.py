...
def audit_capture(capture, *, plan_path, plan_sha256, result_sha256):
    ...
    for index, name in enumerate(expected_ids):
        ...
        records.append(dict(sample_id=name, target_id=row['target_id'], source_target=row['target_id'],
            ...
            anchor_reference_path=rec['anchor_reference_path'], anchor_reference_sha256=rec['anchor_reference_sha256'],
    ...
    return dict(schema='greenhouse.original848_reference_direct_buffer_geometry_audit.v2',
        state='original848_reference_direct_buffers_geometry_replayed_pending_clarity_workspace_review',
