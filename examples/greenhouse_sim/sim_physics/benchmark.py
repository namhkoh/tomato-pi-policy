...
def main(argv=None):
    ...
    if args.station_left_seed_search and not (args.cut_station_orbit and args.native_startup_station_search
            and args.bimanual_cut and not args.right_only_cut_trial and not args.park_left_ready):
    ...
    if args.native_startup_grasp_search and not (args.bimanual_cut and not args.right_only_cut_trial
            and not args.park_left_ready and args.grasp_skew==0 and args.approach_tilt==0
    ...
    try:
        ...
        if args.native_startup_clearance:
            ...
            if args.native_startup_grasp_search:fixture.startup_grasp_search=True
            ...
            if args.station_left_seed_search:fixture.station_left_seed_search=True
